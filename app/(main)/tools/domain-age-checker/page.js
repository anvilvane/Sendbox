...
const tool = getToolBySlug('domain-age-checker');

export const metadata = getSEOTags({
  title: tool.seo.title,
  description: tool.seo.description,
  keywords: tool.seo.keywords,
  canonicalUrlRelative: '/tools/domain-age-checker',
  openGraph: {
    title: `${tool.seo.title} | ${config.appName}`,
    description: tool.seo.description,
    url: `https://${config.domainName}/tools/domain-age-checker`,
  },
});
...
export default function DomainAgeCheckerPage() {
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: tool.name, url: `https://${config.domainName}/tools/domain-age-checker` },
  ]);
