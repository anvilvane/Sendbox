...
export const metadata = getSEOTags({
  ...
  canonicalUrlRelative: '/tools/email-signature-generator',
  openGraph: {
    title: `${tool.seo.title} | ${config.appName}`,
    description: tool.seo.description,
    url: `https://${config.domainName}/tools/email-signature-generator`,
  },
});
...
export default function SignatureGeneratorPage() {
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: tool.name, url: `https://${config.domainName}/tools/email-signature-generator` },
  ]);
