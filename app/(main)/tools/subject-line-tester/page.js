...
export const metadata = getSEOTags({
  ...
  canonicalUrlRelative: '/tools/subject-line-tester',
  openGraph: {
    title: `${tool.seo.title} | ${config.appName}`,
    description: tool.seo.description,
    url: `https://${config.domainName}/tools/subject-line-tester`,
  },
});
...
export default function SubjectLineTesterPage() {
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: tool.name, url: `https://${config.domainName}/tools/subject-line-tester` },
  ]);
